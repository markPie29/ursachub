...
<body>  
    <div class ="admin-main">
        <div class='admin-prod-news-header '>
            ...
            <a href="{{ route('addprodpage') }}"> <div class="btn" > <i class='bx bxs-t-shirt'></i> Add Product <i class='bx bx-plus'></i></div> </a>
        </div>


        <div class="products-ctn">
            @foreach($products as $product)
                <a href="{{ route('show_eachprodpage_admin', $product->id) }}" class="products-card">
